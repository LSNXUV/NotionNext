...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个瑞艾克特coder, Hi，我是一个山地rider, Hi，我是一个内克丝特coder,欢迎来到我的埠洛格🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'NotionNext', // 您的昵称
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的平凡人🍚', // 作者简介
  ...
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTACT_YOUTUBE || 'https://www.youtube.com/@LSuperNovaQ', // Youtube主页
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '渝ICP备2023000759号', // 备案号 渝ICP备2023000759号
